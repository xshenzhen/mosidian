...
import com.example.demo.common.security.AdminUserDetails;
import com.example.demo.common.security.JwtAuthenticationTokenFilter;
import com.example.demo.common.security.RestAuthenticationEntryPoint;
import com.example.demo.common.security.RestfulAccessDeniedHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf()// 由于使用的是JWT，我们这里不需要csrf
                ...
                .permitAll()
                // 对登录注册要允许匿名访问
                .antMatchers("/meLogin","/login","/bcLogin", "/register","/userRegister","/index","/api/*/*/*","/contactUs/update","/member/update")
                .permitAll()
                //跨域请求会先进行一次options请求
