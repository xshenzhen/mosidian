        ...
        <div class="me-navbar">
            <div class="container">
                <nav class="navbar  navbar-expand-lg navbar-light">
                    ...
                    <div class="navbar-brand" href="#"><img src="img/logo.png" width="100px"/><span style="color: white"> 会员管理系统-A端</span>
                    </div>
        ...
        <div class="me-menu">
            <div class="container">
                <ul class="me-menu-item">
                    <li>
                        <a href="/workbench" target="modulecontent"><i class="iconfont icongongzuotai1"></i>&nbsp工作台</a>
                    </li>
                  <#--  <li>
